...
**Full 3-axis sweep vs the PrismML fork (2026-07-18):** 18 sequential same-session runs (threads × SIMD × classifier for project-zero; threads for the fork; 4 interleaved drift sentinels) — project-zero leads **4.2–4.8x at every thread count** (t4: 2.97 vs 0.70 tok/s). Raw terminal screenshots for every run + the comparison infographic: [`benchmark_results/sweep3_2026-07-18/`](benchmark_results/sweep3_2026-07-18/), headline chart: [`comparison_infographic.png`](benchmark_results/sweep3_2026-07-18/comparison_infographic.png).
